...
unset sbt_jar sbt_dir sbt_tmpdir sbt_create sbt_version sbt_snapshot
unset scala_version
unset java_home
...
sbtjar_snapshot_url () {
  ...
  echoerr "sbt version: $sbt_version"
...
cygwin=false;
case "`uname`" in
  CYGWIN*) cygwin=true; default_jvm_opts="$default_jvm_opts -Djline.terminal=jline.UnixTerminal"
esac
